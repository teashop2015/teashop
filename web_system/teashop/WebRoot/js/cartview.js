var Carview = {
	addSimpleCart : function (obj) {
		...
		this.setTotalCountAndPay(price);
	},
	...
	initSimpleCartTotalCount : function (totalCount){
		$("#totalCount").html(totalCount);
		
	},
	
	initSimpleCartTotalPay : function (totalPay) {
		$("#totalPay").html("￥"+totalPay);
	},
	
	setTotalCountAndPay : function (price) {
